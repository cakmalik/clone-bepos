            ...
            <div class="row row-deck row-cards">
                <div class="card mb-5">
                    ...
                    <div class="card-body border-top">
                        <div class="row">
                            <div id="debt-payment-document" class="col-12">
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        function loadReport() {
            let url = '{{ url('/report/debt/payment/print') }}'
            ...
            url += '?' + params.toString()
            $('#debt-payment-document').html(`<iframe id="printframe" src="${url}" style="width: 100%; height: 1500px;"></iframe>`);
        }
