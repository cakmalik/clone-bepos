    ...
    <div class="container-xl">
        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="page-title">
                        Laporan Penerimaan Pembelian (PN)
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="row row-deck row-cards">
                <div class="card py-3">
                    ...
                    <div class="card-body border-top">
                        <div class="row">
                            <div id="purchase-reception-document" class="col-12">
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        function loadReport() {
            let url = '{{ url('/report/purchase/purchase_reception/print') }}'
            ...
            url += '?' + params.toString()
            $('#purchase-reception-document').html(`<iframe id="printframe" src="${url}" style="width: 100%; height: 1500px;"></iframe>`);
        }
