...
@section('page')
            ...
            <div class="row align-items-center">
                <div class="col">
                    <h2 class="page-title text-uppercase">
                        Laporan Stock Gudang Consolidation
                    </h2>
                </div>
            </div>
        </div>
            ...
            <div class="row row-deck row-cards">
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body border-bottom py-3">
                        @include('pages.report.stock_gudang_consolidation.inventory')
    ...
    let urlNota   = app_url+'/report/inventory/stock_gudang/consolidation-data?inventory='+inventoryId+'&recap_date='+recapDate;
    ...
    function refreshData(){
        ...
        urlNota   = app_url+'/report/inventory/stock_gudang/consolidation-data?inventory='+inventoryId+'&recap_date='+recapDate;
