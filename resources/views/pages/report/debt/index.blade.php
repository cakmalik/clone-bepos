            ...
            <div class="row row-deck row-cards">
                <div class="card mb-5">
                    ...
                    <div class="card-body border-top">
                        <div class="row">
                            <div id="debt-document" class="col-12">
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        function loadReport() {
            let url = '{{ url('/report/debt/debt/print') }}'
            const params = new URLSearchParams()
            params.append('supplier_id', $('#input-supplier-id').val())
            params.append('summary_detail', $('#input-summary-detail').val())

            url += '?' + params.toString()
            $('#debt-document').html(`<iframe id="printframe" src="${url}" style="width: 100%; height: 1500px;"></iframe>`);
        }
