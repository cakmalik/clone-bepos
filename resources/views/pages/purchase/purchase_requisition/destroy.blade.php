<a href="javascript:void(0)" class="btn btn-danger" data-bs-toggle="modal"
    data-bs-target="#purchaseRequisition-delete{{ $purchase->id }}">
    <i class="fas fa-times me-2"></i>
    Batal
</a>

<div class="modal fade modal-blur" id="purchaseRequisition-delete{{ $purchase->id }}" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center py-4">
        ...
        <h3>Pembatalan Permintaan (PR)</h3>
        <div class="text-secondary">
          Apakah Anda yakin ingin <strong>membatalkan Permintaan Pembelian</strong>
      ...
      <div class="modal-footer">
        <div class="w-100">
          <div class="row">
            ...
            <div class="col">
              <form action="{{ url('/purchase_requisition', $purchase->id) }}" method="POST">
                @csrf
                @method('delete')
