                ...
                <tr>
                    <th class="report-header-cell">
                        <div class="header-info">
                            <!-- header -->
                            <h2 class="center">Purchase Retur</h2>
                            <br>
                                ...
                                <tr style="padding: 0;">
                                    ...
                                    <td
                                        ...
                                        <table style="width: 100%; border: 0;">
                                            <tr>
                                                <td style="width:25%;text-align: left;">Nomor Retur</td>
                                            ...
                                            <tr>
                                                <td style="text-align: left;">Nomor PO</td>
                        ...
                        <div class="main">
                            ...
                            <table class="border-cust">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($purchase->purchase_detail_retur as $pd)
                                        <tr class="border-lr">
