<div class="col-auto ms-auto d-print-none">
    <div class="btn-list">
        <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#purchase-reception-supplier-create">
            <i class="fas fa-plus me-2"></i>
            Supplier
        </a>
    </div>
    <div class="modal modal-blur fade" id="purchase-reception-supplier-create" tabindex="-1" role="dialog"
        aria-hidden="true">
