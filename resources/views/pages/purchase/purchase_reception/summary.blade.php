                                    ...
                                    <td
                                        ...
                                        <table style="width: 100%; border: 0;">
                                            ...
                                            <tr>
                                                ...
                                                <td>:</td>
                                                <td>
                                                    {{ isset($purchase->inventory) ? 'GUDANG - ' . $purchase->inventory->name : 'OUTLET - ' . $purchase->outlet->name }}
                        ...
                        <div class="main">
                            ...
                            <table class="border-cust">
                                ...
                                <tr>
                                    ...
                                    <th class="center border-btm border-tp">Tipe</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($purchase->purchase_detail_reception as $pd)
                                        <tr class="border-lr">
                                            <td>{{ $pd->product_name }}</td>
                                            <td>{{ $pd->is_bonus == 1 ? 'Bonus' : 'Pembelian' }}</td>
                                    ...
                                    @if ($purchase->is_invoiced)
                                        <tr class="border-cust border-lr">
                                            <td class="right" colspan="5"><b>Diskon</b>
                                            </td>
                                            <td class="right">
                                                <b>{{ rupiah($purchase->purchaseInvoice->nominal_discount) }}</b>
                                            </td>
                                        </tr>
                                    @endif
                                    ...
                                    <tr class="border-cust border-lr">
                                        ...
                                        <td class="right">
                                            <b>{{ rupiah(number_format($total, 0, ',', '.')) }}</b>
                                        </td>
                                    </tr>
