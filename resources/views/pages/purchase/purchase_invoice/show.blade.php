            ...
            <div class="row row-deck row-cards">
                <div class="card mb-5">
                    <div class="card-header">
                        <h3 class="card-title">No Tagihan: {{ $purchaseInvoice->invoice_number }}</h3>
                    </div>
...
@push('scripts')
    <script>
        ...
        let codeTransaction = '{{ $purchaseInvoice->purchase->code }}';

        let urlNota = app_url + '/purchase_invoice_nota/' + codeTransaction + '/';
