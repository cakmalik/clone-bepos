                ...
                <tr>
                    <th class="report-header-cell">
                        <div class="header-info">
                            <!-- header -->
                            <h2 class="center">Tagihan Pembelian</h2>
                            <br>
                        ...
                        <div class="main">
                            ...
                            <table class="border-cust">
                                ...
                                <tr>
                                    ...
                                    <th class="center border-btm border-tp" width="7%">Qty</th>
                                    <th class="center border-btm border-tp" width="15%">Harga</th>
                                    <th class="center border-btm border-tp" width="15%">Subtotal</th>
                                </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr class="border-cust border-lr">
                                        <td class="right" style="width: 80%;" colspan="3"><b>Diskon</b></td>
                                        <td class="right">
                                            <b>
                                                {{ rupiah(floatval($purchaseInvoice->nominal_discount)) }}
                                            </b>
                                        </td>
                                    </tr>
                                    <tr class="border-cust border-lr">
                                        <td class="right" style="width: 80%;" colspan="3"><b>Total Retur</b">
                                        </td>
                                        <td class="right">
                                            <b>
                                                {{ rupiah(floatval($purchaseInvoice->nominal_returned)) }}
                                            </b>
                                        </td>
                                    </tr>
                                    <tr class="border-cust border-lr">
                                        <td class="right" style="width: 80%;" colspan="3"><b>Total Tagihan</b">
                                        </td>
                                        <td class="right">
                                            <b>
                                                {{ rupiah(floatval($purchaseInvoice->total_invoice)) }}
                                            </b>
                                        </td>
                                    </tr>
                                    <tr class="border-cust border-lr">
                                        <td class="right" style="width: 80%;" colspan="3"><b>Terbayar</b">
                                        </td>
                                        <td class="right">
                                            <b>
                                                {{ rupiah(floatval($purchaseInvoice->nominal_paid)) }}
                                            </b>
                                        </td>
                                    </tr>
                                </tbody>
