        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                <div class="form-group text-end">
                    <a href="{{ route('cashProofOut.create') }}" class="btn btn-primary">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-sm-6 col-md-3">
                                ...
                                <input id="filter-start-date" type="date" name="start_date"
                                       class="form-control filter-cash-proof-out"
                                       value="{{ date('Y-m-d')}}">
                            </div>
                            <div class="col-12 col-sm-6 col-md-3">
...
@push('scripts')
    <script>
        ...
        $(document).ready(function () {
            table = $('#cash-proof-out-table').DataTable({
                destroy: true,
                processing: true,
                serverSide: true,
                searching: false,
            ...
            $('.filter-cash-proof-out').each(function () {
