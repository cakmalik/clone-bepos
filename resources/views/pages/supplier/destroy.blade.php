<a href="" class="btn btn-danger btn-sm py-2 px-3" data-bs-toggle="modal" data-bs-target="#product_unit-delete{{ $sp->id }}">
    <li class="fas fa-trash"></li>
</a>
<div class="modal modal-blur fade" id="product_unit-delete{{ $sp->id }}" tabindex="-1" role="dialog" aria-hidden="true">
