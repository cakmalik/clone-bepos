                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Update Claim Points</h3>
                                </div>
                                <form method="POST">
                                    @csrf
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('product_id') is-invalid @enderror"
                                                        ...
                                                        <option value="0" disabled selected> &mdash; Pilih Produk &mdash;</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="amount" value="{{ $data->previous_score }}" id="amount" required>
                                                    <div id="info"> </div>
                                                    @error('amount')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        name="qty" value="{{ $data->qty }}" id="qty" required>
                                                    <div id="info"> </div>
                                                    @error('qty')
                                                        <div class="alert alert-danger">{{ $message }}</div>
                                                    @enderror
...
<script>
    function submitForm() {
        ...
        var url = '/loyalty_point/' + loyaltyId + '/product';
        $.ajax({
            type: 'POST',
            url: url,
            data: formData,
