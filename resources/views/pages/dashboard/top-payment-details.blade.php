    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h2 class="page-title mb-0">Pembayaran Terbanyak</h2>
            ...
            <div class="card py-3" style="border-radius: 1rem">
                <div class="card-body py-3">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="topPaymentTable">
                            <thead>
                                <tr>
...
@push('js')
    <script>
        ...
        $(function() {
            ...
            if ($.fn.DataTable.isDataTable('#topPaymentTable')) {
                $('#topPaymentTable').DataTable().clear().destroy();
            }

            table = $('#topPaymentTable').DataTable({
                pageLength: 25,
                info: true,
                searching: true,
                lengthChange: true,
            ...
            function fetchDashboardData(startDate, endDate) {
                ...
                $.ajax({
                    url: '/dashboard/top-payment-method-data',
                    method: 'GET',
                    data: {
                    ...
                    success: function(response) {
                        ...
                        if (response.paymentDetails.length === 0) {
                            table.row.add([
                                '',
                                '',
                            ...
                            response.paymentDetails.forEach((paymentDetail, index) => {
                                table.row.add([
                                    index + 1,
                                    paymentDetail.payment_method,
                                    paymentDetail.transaction_count,
                                    formatter.format(paymentDetail.total_qty) + ' ' + paymentDetail.unit_symbol,
                                    currencyFormatter.format(paymentDetail.total_sales),
                                    paymentDetail.last_transaction ? moment(paymentDetail.last_transaction).format('DD-MM-YYYY') : '-'
                                ]);
                            });
                        }
