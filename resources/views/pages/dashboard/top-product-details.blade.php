    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                <div>
                    <h2 class="page-title mb-0">Produk Terlaris</h2>
            ...
            <div class="card py-3" style="border-radius: 1rem">
                <div class="card-body py-3">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="topProductTable">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nama Produk</th>
...
<script>
    ...
    $(function() {
        ...
        if ($.fn.DataTable.isDataTable('#topProductTable')) {
            $('#topProductTable').DataTable().clear().destroy();
        }

        table = $('#topProductTable').DataTable({
            pageLength: 25,
            info: true,
            searching: true,
            lengthChange: true,
            columns: [
                ...
                { title: "Sisa Stok", className: "text-end", width: "10%" },
            ],
        ...
        function fetchDashboardData(startDate, endDate) {
            ...
            $.ajax({
                url: '/dashboard/top-product-data',
                method: 'GET',
                data: {
                ...
                success: function(response) {
                    ...
                    if (response.topProduct.length === 0) {
                        table.row.add([
                            '',
                            '',
                            '',
                        ...
                        response.topProduct.forEach((product, index) => {
                            table.row.add([
                                index + 1,
                                product.product_name,
                                product.transaction_count,
                                formatter.format(product.total_qty) + ' ' + product.unit_name,
                                currencyFormatter.format(product.total_sales),
