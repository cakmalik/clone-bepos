        ...
        <div class="container-xl">
            <div class="row row-deck row-cards">
                ...
                <div class="form-group text-end">
                    <a href="{{ route('stockMutation.create') }}" class="btn btn-primary">
                ...
                <div class="card mb-5">
                    <div class="card-header">
                        <h3 class="card-title">Stok Mutasi</h3>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            table = $('#stock-mutation-table').DataTable({
                ...
                columns: [{
                        data: row => `<a href="{!! url('stock_mutation/print') !!}/${row.id}">${row.code}</a>`,
                        name: 'code'
                    },
                    {
                    ...
                    {
                        data: row => row.inventory_destination.name,
                    ...
                    {
                        data: row => `<a href="{{ url('stock_mutation') }}/print/${row.id}">
