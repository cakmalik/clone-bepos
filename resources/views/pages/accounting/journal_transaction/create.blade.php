                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Buat Jurnal</h3>
                                </div>
                                <form id="create-journal-transaction-form" action="{{ route('journal_transaction.store') }}"
                                    method="POST">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                                            ...
                                                            <select name="journal_type_id"
                                                                ...
                                                                @foreach ($journalTypes as $journalType)
                                                                    <option value="{{ $journalType->id }}"
                                                                        {{ old('journal_type_id') == $journalType->id ? 'selected' : '' }}>
                                                                        {{ $journalType->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="journal_debit_account_id"
                                                                ...
                                                                @foreach ($journalAccounts as $journalAccount)
                                                                    <option value="{{ $journalAccount->id }}"
                                                                        {{ old('journal_debit_account_id') == $journalAccount->id ? 'selected' : '' }}>
                                                                        {{ $journalAccount->name }}</option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select name="journal_credit_account_id"
                                                                ...
                                                                @foreach ($journalAccounts as $journalAccount)
                                                                    <option value="{{ $journalAccount->id }}"
                                                                        {{ old('journal_credit_account_id') == $journalAccount->id ? 'selected' : '' }}>
                                                                        {{ $journalAccount->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            ...
                                                            <select name="outlet_id"
                                                                ...
                                                                @foreach ($outlets as $outlet)
                                                                    <option value="{{ $outlet->id }}"
                                                                        {{ old('outlet_id') ? (old('outlet_id') == $outlet->id ? 'selected' : '') : ($activeOutlet->id == $outlet->id ? 'selected' : '') }}>
                                                                        {{ $outlet->name }}{{ $activeOutlet->id == $outlet->id ? ' (Main Outlet)' : '' }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        </div>
