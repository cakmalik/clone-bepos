    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="btn-list justify-content-end">
                <a href="{{ route('journal_type.create') }}" class="btn btn-primary">
                                    ...
                                    @foreach ($journalTypes as $journalType)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('journal_type.edit', $journalType->id) }}"
                                                ...
                                                <a class="btn btn-danger btn-sm py-2 px-3"
                                                    onclick="JournalType({{ $journalType->id }})">
        ...
        function JournalType(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('/accounting/journal_type') }}" + '/' + id,
                        type: "POST",
                        data: {
                            '_method': 'DELETE',
                            _token: "{{ csrf_token() }}"
