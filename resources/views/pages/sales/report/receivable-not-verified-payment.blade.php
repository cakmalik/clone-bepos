                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body border-bottom py-3">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="origin" class="mb-2">Filter Jenis</label>
                                    <select name="type" id="type" class="form-select">
                                        <option value="">-- Semua --</option>
                                        <option value="PIUTANG">Tipe Pembayaran PIUTANG</option>
                                        <option value="NOTVERIVIED">Invoice Belum Diverifikasi</option>
...
<script>
    ...
    let urlNota   = app_url+'/report/receivable-payment-not-verified-data?start_date='+start_date+'&end_date='+end_date;
