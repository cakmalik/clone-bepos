...
<script>
    ...
    let urlNota   = app_url+'/report/receivable-data?start_date='+start_date+'&end_date='+end_date;
    ...
    $('#refreshReport').click(function() {
        ...
        let urlNota   = app_url+'/report/receivable-data?start_date='+start_date+'&end_date='+end_date+'&customer='+customer;
        $('#loadingProgress').html(proses(1));
