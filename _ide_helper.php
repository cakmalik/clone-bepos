...
namespace LaravelReady\ReadableNumbers\Facades {
     ...
     */        class ReadableNumbers {
         ...
         * @return string 
         * @static 
         */        public static function make($value, $decimals = 1, $lang = null)
        {
                        return \LaravelReady\ReadableNumbers\Services\ReadableNumbers::make($value, $decimals, $lang);
        }
                    /**
         ...
         * @return string 
         * @static 
         */        public static function format($value, $decimals, $threshold, $suffix)
        {
                        return \LaravelReady\ReadableNumbers\Services\ReadableNumbers::format($value, $decimals, $threshold, $suffix);
        }
            }
    }
...
namespace  {
            ...
            class Pdf extends \Barryvdh\DomPDF\Facade\Pdf {}
            class ReadableNumbers extends \LaravelReady\ReadableNumbers\Facades\ReadableNumbers {}
