...
class StockAdjustmentReportController extends Controller
{
    public function index()
    {
        ...
        return view('pages.report.stock_adjustment.index', compact('inventories', 'outlet'));
    }
    ...
    public function print(Request $request)
    {
        try {
            ...
            $query = StockOpname::with('inventory', 'outlet', 'user', 'adjustment_detail.product.productCategory')
            ...
            return view('pages.report.stock_adjustment.print', compact(
                'opnames',
                'start_date',
                'end_date',
                'inventory_id',
